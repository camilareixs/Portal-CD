...
const compraCard = {
  display: "grid",
  gridTemplateColumns:
    "minmax(180px,2fr) minmax(120px,1fr) minmax(110px,1fr) minmax(120px,1fr)",
  gap: 16,
  padding: 16,
  borderRadius: 12,
  background: "#f9f9f9",
